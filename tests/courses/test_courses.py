...
class TestPositiveCourses:
    ...
    def test_positive_empty_courses_list(self, courses_list_page: CoursesListPage):
    ...
    @pytest.mark.courses
    @pytest.mark.regression
    def test_positive_create_course(
        self,
